...
namespace titanium {
	namespace bindings {
		...
		class PlayServicesBindings {
			public:
				static BindEntry* lookupGeneratedInit(const char*, unsigned int);
		};

		BindEntry* PlayServicesBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"ti.playservices.PlayServicesModule", ::ti::playservices::PlayServicesModule::bindProxy, ::ti::playservices::PlayServicesModule::dispose}
			};
